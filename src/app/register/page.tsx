        ...
        <div className="bento-card p-8">
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-[#e5e5e5] rounded-xl bg-white hover:bg-[#f5f5f5] transition text-[#0a0a0a] font-medium disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <button
              ...
              disabled={oauthLoading !== null}
              className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-xl bg-[#24292e] hover:bg-[#2f363d] transition text-white font-medium disabled:opacity-50 disabled:cursor-not-allowed"
            >
              ...
              {oauthLoading === "github" ? "Inscription..." : "Continuer avec GitHub"}
            </button>
          </div>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-white text-[#525252]">ou</span>
            </div>
          </div>
