        ...
        <div style={{ border: "var(--rule)", background: "var(--card)" }}>
          ...
          <div style={{ padding: "1.5rem" }}>
            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <span style={{ fontSize: "0.62rem", textTransform: "uppercase", letterSpacing: "0.1em", color: "var(--light)", fontFamily: "var(--font-sans)" }}>ou</span>
              <div style={{ flex: 1, height: 1, borderTop: "var(--rule-thin)" }} />
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input id="name" type="text" value={name} onChange={(e) => setName(e.target.value)} className="input" placeholder="Votre nom" required />
              </div>
              <div>
                <label htmlFor="email" style={labelStyle}>Email</label>
                <input id="email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} className="input" placeholder="vous@exemple.com" required />
              </div>
              <div>
                <label htmlFor="password" style={labelStyle}>Mot de passe</label>
                <input id="password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} className="input" placeholder="Min. 6 caractères" required minLength={6} />
              </div>
              <div>
