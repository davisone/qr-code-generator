        ...
        <div style={{ border: "var(--rule)", background: "var(--card)" }}>
          ...
          <div style={{ padding: "1.5rem" }}>
            ...
            <div className="flex items-center gap-3 mb-5">
              <div style={{ flex: 1, height: 1, background: "var(--rule-thin)", borderTop: "var(--rule-thin)" }} />
            ...
            <p className="mt-5 text-center" style={{ fontSize: "0.75rem", color: "var(--mid)" }}>
              ...
              <Link href="/register" style={{ color: "var(--ink)", fontWeight: 700, textDecoration: "underline" }}>
                Créer un compte
              </Link>
            </p>
          </div>
  ...
  return (
    <Suspense fallback={
      <div className="min-h-screen flex items-center justify-center" style={{ background: "var(--bg)" }}>
        <span style={{ fontFamily: "var(--font-display, cursive)", fontSize: "1.5rem", color: "var(--mid)", letterSpacing: "0.06em" }}>
          Chargement...
        </span>
      </div>
    }>
