...
Head to the [useqraft WiFi generator](/qr-code-generator/wifi) and fill in the fields:
...
<InfoBox type="info">
No data passes through useqraft. The QR code is generated in the browser and never leaves your device.
</InfoBox>
