...
1. Head to the [useqraft Menu generator](/qr-code-generator/menu-restaurant)
...
With useqraft's free QR code, the link is **static** — it always points to the same URL. If your menu is a web page that you update, that's perfect: the QR code doesn't change, but the content evolves.
